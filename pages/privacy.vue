      ...
      <div class="h-full overflow-y-auto text-white px-4 pb-4 flex flex-col gap-6 space-y-1">
        <LabeledText label="Impressum" class="flex flex-col gap-4">
          <LabeledText label="Angaben gemäß § 5 DDG" small>
            John Wagner<br>
            Adenauerallee 119a<br>
            52066 Aachen<br>
          </LabeledText>
          <LabeledText label="Vertreten durch" small>
            John Wagner
          </LabeledText>
          <LabeledText label="Kontakt" small>
            Telefon: +49 152 53397079<br>
            Email: info@techbra.in<br>
          </LabeledText>
          <LabeledText label="Umsatzsteuer-ID" small>
            Umsatzsteuer-Identifikationsnummer gemäß §27a Umsatzsteuergesetz: DE352723704
          </LabeledText>
          <LabeledText label="Haftungsausschluss" small>
            <LabeledText label="Haftung für Inhalte" small>
            ...
            <LabeledText label="Haftung für Links" small>
            ...
            <LabeledText label="Urheberrecht" small>
            ...
            <LabeledText label="Datenschutz" small>
