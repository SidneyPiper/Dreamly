<template>
  <div
    ...
    <NuxtLink class="grow py-10 lg:py-4 flex items-center justify-center lg:justify-start gap-4 relative" to="/search">
      <span class="w-8 h-8">
        <Transition>
    ...
    <NuxtLink class="grow py-10 flex lg:hidden items-center justify-center relative" to="/dream">
    ...
    <NuxtLink class="grow py-10 lg:py-4 flex items-center justify-center lg:justify-start gap-4 relative"
              to="/calendar">
      <span class="w-8 h-8">
        <Transition>
    ...
    <NuxtLink class="grow py-10 lg:py-4 flex items-center justify-center lg:justify-start gap-4 relative" to="/profile">
      <span class="w-8 h-8">
        <Transition>
